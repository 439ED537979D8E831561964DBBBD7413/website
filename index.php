...
<html>
  ...
  <body id="page">
    ...
    <input type="hidden" id ="myNameee" <?php echo'value="'.$_SESSION['myUserfName'].' '.$_SESSION['myUserlName'].'"' ?>>
          ...
          <div class="col-md-9" role="main">
            <div class="row">
              <div class="form-group col-md-12" style=" padding-right:0px;">
                <label for="textinput">&nbsp; Share Stuff:</label>
                <textarea type="text" class="form-control" id="textinput"  placeholder="Enter whatever text"></textarea>
              </div>
              <div style="margin-left:20px;">
                <button class="btn btn-default" id="btn_share" >Share</button>
              </div>
            </div>
            <div class="row" style="margin-left:10px;">
              <div><h3>News Feed</h3></div>
                <div class="posts scrollable" id="style-gray">

            </div>
            </div>
          </div>
          <div class="col-md-3" role="complementary">
             <nav class="bs-docs-sidebar hidden-print hidden-sm-down affix" id="adsNav">
    ...
    <script type="text/javascript" src="jsfiles/posts.js">
